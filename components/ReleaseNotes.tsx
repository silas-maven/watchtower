 ...
 * looked at without an admin session, rather than a second copy of it being
 * written for that purpose. Presentational only: the page supplies the data.
 */
export function ReleaseNotes({ releases, sampleAssetId }: { releases: Release[]; sampleAssetId: string | null }) {
  return (
    <>
